...
namespace ResimSecme_Sayfa155_157
{
    public partial class Form1 : Form
    {
        ...
        //resimde seçilen alanın koordinat bilgilerini tutulması için
        Rectangle secili_alan = new Rectangle(0, 0, 0, 0);

        private void resimyukle_Click(object sender, EventArgs e)
        {
            openFileDialog1.Filter = "Resim Dosyaları | *.bmp; *.jpeg; *.jpg; *.gif";
        ...
        private void sagacevir_Click(object sender, EventArgs e)
        {
            if((secili_alan.Height ==0) ||(secili_alan.Width == 0))
            {
                MessageBox.Show("Seçili alan yok");
